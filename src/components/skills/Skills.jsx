    ...
    <Section style={{ background: "#f7f7ff" }}>
      <div className="container">
        <SectionHeader
          ...
          style={{ color: "#6871d7" }}
        ></SectionHeader>
        <div className={classes["skills-card-holder"]}>
          <Card>
            <svg viewBox="0 0 128 128">
              ...
              >
                <stop offset="0" stop-color="#6871d7"></stop>
                <stop offset="1" stop-color="#6871d7"></stop>
              </linearGradient>
              <linearGradient
                ...
                gradientTransform="matrix(.563 0 0 -.568 -29.215 707.817)"
              >
                <stop offset="0" stop-color="#6871d788"></stop>
                <stop offset="1" stop-color="#6871d788"></stop>
              </linearGradient>
              <path
