      ...
      <div className="container">
        <object type="image/svg+xml" data="some.svg">
            ...
            <div className={classes["slider-track"]}>
              <Card>
                <svg viewBox="0 0 128 128">
                  ...
                  >
                    <stop offset="0" stopColor="#6871d7"></stop>
                    <stop offset="1" stopColor="#6871d7"></stop>
                  </linearGradient>
                  <linearGradient
                    ...
                    gradientTransform="matrix(.563 0 0 -.568 -29.215 707.817)"
                  >
                    <stop offset="0" stopColor="#6871d788"></stop>
                    <stop offset="1" stopColor="#6871d788"></stop>
                  </linearGradient>
                  <path
          ...
          >
            ...
            <li class="list-group-item">
              <span className={classes["techTitle"]}>Databases:</span> MySQL /
              SQL Server / ORACLE / Neo4J
            </li>
          </ul>
        </object>
      </div>
